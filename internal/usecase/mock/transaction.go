...
// Source: travel-api/internal/usecase (interfaces: TransactionManager)
//
// Generated by this command:
//
//	mockgen -destination mock/transaction.go travel-api/internal/usecase TransactionManager
//
