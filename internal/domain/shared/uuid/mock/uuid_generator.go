...
// Source: travel-api/internal/domain/shared/uuid (interfaces: UUIDGenerator)
//
// Generated by this command:
//
//	mockgen -destination mock/uuid_generator.go travel-api/internal/domain/shared/uuid UUIDGenerator
//
